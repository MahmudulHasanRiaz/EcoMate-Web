...
import { useEarningsQuery, useApproveEarningMutation } from '../hooks'
import type { EarningRow, LedgerStatus } from '../api'
      ...
      <CardHeader>
        <div className='flex flex-wrap items-center justify-between gap-2'>
          <div>
            ...
            <CardDescription>Bonus, incentive, commission and other earnings.</CardDescription>
          </div>
          <EarningDialog employeeId={employeeId} />
        </div>
      </CardHeader>
      <CardContent>
        {isLoading ? (
