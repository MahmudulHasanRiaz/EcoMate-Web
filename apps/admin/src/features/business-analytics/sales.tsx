...
const SALES_DRILLDOWN: DrilldownItem[] = [
  ...
  { label: 'Fulfillment Margin → recognised-revenue ladder', description: 'Courier cost appears once in the P&L Fulfillment Cost line', to: '/op/analytics/overview', params: { view: 'ladder' } },
]
