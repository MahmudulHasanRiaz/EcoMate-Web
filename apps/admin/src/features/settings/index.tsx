...
export function Settings() {
  ...
  const monNavGroups = [
    ...
    },
    {
      ...
      { title: 'Homepage Sections', href: '/mon/settings/homepage', icon: <Monitor size={18} /> },
  ...
  return (
    <>
      ...
      <Main fixed>
        ...
        <div className='flex flex-1 flex-col space-y-2 overflow-hidden md:space-y-2 lg:flex-row lg:space-y-0 lg:space-x-12 lg:overflow-hidden'>
          <aside className='top-0 lg:sticky lg:w-1/5 lg:flex lg:flex-col lg:overflow-hidden lg:self-start lg:max-h-[calc(100vh-10rem)]'>
