...
const DEFAULT_CONFIG: StorefrontConfig = {
  ...
  order: { whatsapp: "", callNumber: "", blockedPhoneMessage: "This phone number has been blocked. Please contact support." },
  ...
  checkout: { districtEnabled: true, thanaEnabled: true, districtRequired: false, thanaRequired: false, emailEnabled: true, emailRequired: false, paymentOptions: { FULL_PAYMENT: true, PARTIAL_PAYMENT: true, CASH_ON_DELIVERY: true } },
  districtCharges: {},
