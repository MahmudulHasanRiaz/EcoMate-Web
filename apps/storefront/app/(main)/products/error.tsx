  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center px-4">
        <h1 className="text-4xl font-bold text-red-600 mb-4">Failed to load products</h1>
        <p className="text-gray-600 mb-6">{error.message || 'An error occurred while loading products.'}</p>
        <button
          onClick={reset}
