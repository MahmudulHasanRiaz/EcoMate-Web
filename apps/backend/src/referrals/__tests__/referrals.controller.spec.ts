...
describe('ReferralsController', () => {
  ...
  describe('admin methods', () => {
    it.each(adminMethods)('adds RequiresFeature(admin_referrals) on %s', (method) => {
      const meta = Reflect.getMetadata(REQUIRES_FEATURE_KEY, ReferralsController.prototype[method]);
