                ...
                this.mapToItemXml(
                  {
                    ...
                    link: `${process.env.STOREFRONT_URL || 'https://yourstore.com'}/products/${product.slug}?variant=${variant.id}`,
              ...
              this.mapToItemXml(
                {
                  ...
                  link: `${process.env.STOREFRONT_URL || 'https://yourstore.com'}/products/${product.slug}`,
                  imageLink: img.primary,
                  additionalImageLinks: img.additional,
                  availability:
