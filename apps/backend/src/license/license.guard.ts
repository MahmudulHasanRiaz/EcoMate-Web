...
const LICENSE_ERROR_MESSAGES: Record<string, string> = {
  ...
  unauthorized: 'Authorization failed. Please check your license configuration.',
  unreachable: 'License server unreachable. The application may have limited functionality until connectivity is restored.',
  ...
  decryption_failed: 'Cannot decrypt stored credentials. The encryption key may have changed.',
