# Warehouse Hierarchy UI Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add a dedicated Warehouse Hierarchy page for creating/editing/deleting Zone/Rack/Shelf entities.

**Architecture:** New frontend page and component under the existing Inventory feature. Reuses existing backend CRUD endpoints (no backend changes). Uses same patterns as bin-locations.tsx (TanStack Query, shadcn Dialog, Select, toast).

**Tech Stack:** React, TanStack Query, shadcn/ui, TanStack Router, apiClient

---

### Task 1: Create WarehouseHierarchy component

**Files:**
- Create: `apps/admin/src/features/inventory/warehouse-hierarchy.tsx`
- Test: `npx tsc --noEmit` after creation
...
**Files:**
- Create: `apps/admin/src/routes/_authenticated/op/inventory/hierarchy.tsx`
...
- [ ] **Step 1: Add hierarchy item after bin-locations**

In `apps/admin/src/components/layout/data/sidebar-data.ts`, add a new item after line 52:

```tsx
{ title: 'Warehouse Hierarchy', url: '/op/inventory/hierarchy', feature: 'admin_warehouses' },
```

Edit: Line 52 currently is:
```tsx
